          ...
          #              project = "CSC"
           #         elif "Community Assisted" in project:
            #            project = "CASL"
                    ...
                    array = [date, agency, project, hmis_id, projType, str(time1) + '%', str(enroll1) + '%', str(name1) + '%', str(ssn1) + '%', str(dob1) + '%', str(race1) + '%', str(eth1) + '%', str(gen1) + '%', str(vet1) + '%', str(exitDest1) + '%', str(chron1) + '%', str(inactive1) + '%', str(disable1) + '%', str(start1) + '%', str(Annual1) + '%', str(exit1) + '%', str(hoh1) + '%', str(totalScore) + '%', grade, quarter(d.month),fy(d)]
                    
                    
                    filename = quarter(d.month) + ' Scorecard_'+ agency.replace(':', '-') + '_' + str(hmis_id) + '_' + projecttype + '_' + fy(d) + '.docx'
